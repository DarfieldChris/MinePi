    ...
    def copy_recursive(self, orig_dict, new_dict):
        for key in orig_dict:
            if isinstance(orig_dict[key],dict):
                dict_class = orig_dict[key].get("CLASS", "NestedDict")
                new_dict[key] = eval(dict_class + "()")
                new_dict[key]["PARENT"] = new_dict
...
# These imports required for dynamic class allocation .... UGLY
